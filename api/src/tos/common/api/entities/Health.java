...
public enum Health {
  alcohol_free("Alcohol-free", "alcohol-free", "No alcohol used or contained"),
  celery_free("Celery-free", "celery-free", "does not contain celery or derivatives"),
  crustacean_free(
      "Crustacean-free",
      "crustacean-free",
      "does not contain crustaceans (shrimp, lobster etc.) or derivatives"),
  dairy_free("Dairy", "dairy-free", "No dairy,no lactose"),
  egg_free("Eggs", "egg-free", "No eggs or products containing eggs"),
  fish_free("Fish", "fish-free", "No fish or fish derivatives"),
  gluten_free("Gluten", "gluten-free", "No ingredients containing gluten"),
  kidney_friendly(
      "Kidney friendly",
      "kidney-friendly",
  ...
  low_potassium("Low potassium", "low-potassium", "Less than 150mg per serving"),
  lupine_free("Lupine-free", "lupine-free", "does not contain lupine or derivatives"),
  mustard_free("Mustard-free", "mustard-free", "does not contain mustard or derivatives"),
  No_oil_added(
      "No oil added",
      "No-oil-added",
  ...
  peanut_free("Peanuts", "peanut-free", "No peanuts or products containing peanuts"),
  pescatarian(
      "Pescatarian",
      "pescatarian",
      "Does not contain meat or meat based products, can contain dairy and fish"),
  pork_free("Pork-free", "pork-free", "does not contain pork or derivatives"),
  red_meat_free(
      "Red meat-free",
      "red-meat-free",
      "does not contain beef, lamb, pork, duck, goose, game, horse, and other types of red meat or products containing red meat."),
  sesame_free("Sesame-free", "sesame-free", "does not contain sesame seed or derivatives"),
  shellfish_free("Shellfish", "shellfish-free", "No shellfish or shellfish derivatives"),
  soy_free("Soy", "soy-free", "No soy or products containing soy"),
  sugar_conscious("Sugar-conscious", "sugar-conscious", "Less than 4g of sugar per serving"),
  tree_nut_free("Tree Nuts", "tree-nut-free", "No tree nuts or products containing tree nuts"),
  vegan("Vegan", "vegan", "No meat, poultry, fish, dairy, eggs or honey"),
  vegetarian("Vegetarian", "vegetarian", "No meat, poultry, or fish"),
  wheat_free("Wheat-free", "wheat-free", "No wheat, can have gluten though");
  ...
  public static Health getByLabel(String label) {
    for (Health health : ALL_VALUES) {
      if (health.label.equals(label) || health.apiParameter.equalsIgnoreCase(label)) {
        return health;
      }
    }
    return null;
